    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-4 w-100">
          ...
          <form>
              <input type="text" placeholder="Cari Data Kode Grup 3"  style="width:80%" name="find">
        ...
        <div class="content-wrapper">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2>Kode Grup 3</h2>
                    <p class="mb-md-0">Dashboard Halaman Kode Grup 3.</p>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Data Kode Grup 3</p>
                  ...
                  <div class="table-responsive">
                    <table id="recent-purchases-listing" class="table">
                      ...
                      <tbody>
                      <?php foreach ($kodegrup3s as $key => $kodegrup3):?>
                        <tr>
                            <td><?php echo $kodegrup3['id']; ?></td>
                            <td><!--a href="<?php echo site_url('kodegrup1/detail/' .$kodekantor['id']);?>"-->
                                <?php echo $kodegrup3['nama']; ?>
                                </a>
                            </td>
                            <!--td>
                                <a href="<?php echo site_url('kodegrup3/edit/'.$kodekantor['id']); ?>"> Edit</a>
                                <a href="<?php echo site_url('kodegrup3/delete/'.$kodekantor['id']); ?>">Delete</a>
