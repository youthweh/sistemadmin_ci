        ...
        <div class="content-wrapper">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2>Kode Grup 1</h2>
                    <p class="mb-md-0">Dashboard Halaman Kode Grup 1.</p>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Data Kode Grup 1</p>
                  ...
                  <div class="table-responsive">
                    <table id="recent-purchases-listing" class="table">
                      ...
                      <tbody>
                      <?php foreach ($kodegrup1s as $key => $kodegrup1):?>
                        <tr>
                            <td><?php echo $kodegrup1['id']; ?></td>
                            <td><!--a href="<?php echo site_url('kodegrup1/detail/' .$kodekantor['id']);?>"-->
                                <?php echo $kodegrup1['nama']; ?>
                                </a>
                            </td>
                            <!--td>
                                <a href="<?php echo site_url('kodegrup1/edit/'.$kodekantor['id']); ?>"> Edit</a>
                                <a href="<?php echo site_url('kodegrup1/delete/'.$kodekantor['id']); ?>">Delete</a>
